...
const UserDetails = ({ user }) => (
  <table className="table table-striped user-details-box mt-3">
    <thead>
      <tr>
          ...
          <div className="d-flex flex-column align-items-center" style={{ marginTop: '50px' }}>
            ...
            {showCreateGroupOptions && (
              <div className="create-container d-flex flex-column justify-content-center align-items-center">
                ...
                <button className="btn btn-secondary mt-3" onClick={toggleCreateGroupOptions}>
                  Back
                </button>
              </div>
            )}
            {showManageGroupsView && (
              <div className="manage-container-fluid d-flex flex-column justify-content-center align-items-center" style={{ width: '100%' }}>
                <div className="w-100">
                ...
                <button className="btn btn-secondary mt-3" onClick={handleManageGroupsClick}>
                  Back
                </button>
              </div>
            )}
